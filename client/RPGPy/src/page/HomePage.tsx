        ...
        <div>
            ...
            <div className="home">
                <div className="home-cont">
                    <motion.div
                        initial={{y:100, opacity:0}} // Start From down
                        animate={{y:0, opacity:1}} // to the position that assigned
                        exit ={{y:-100, opacity:0}} // End and Push to up
                        transition={{
                            duration:1,
                            ease:"easeInOut",
                    ...
                    >
                        <p className="home-cont-title">Learning Python With Fun</p>
                        <p className="home-cont-title">With the Hybrid Education Game</p>
                    </motion.div>
                    ...
                    >
                        <p className="home-cont-Text">Over 100+ Components waiting for You !</p>
                    </motion.div>
                    
                    
                </div>
            </div>
            <div className="contain-blw">
                <motion.div  
                ...
                >
                    <div>
                        <p className="home-title">Play With Friends</p>
                        <p className="home-text">To Increase the Fun and Learning Environment !</p>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" version="1.1" id="Layer_1" width="800px" height="800px" viewBox="0 0 256 240" enable-background="new 0 0 256 240" className="pyLogo">
